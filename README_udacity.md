...
Alternatively, you can download the project template package(opens in a new tab) and put the contents of the package in their respective folders in your local Airflow installation.
